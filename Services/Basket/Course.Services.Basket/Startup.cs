...
namespace Course.Services.Basket
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IRedisSettings>(opt =>
            {
                return opt.GetRequiredService<IOptions<RedisSettings>>().Value;
            });
            services.AddSingleton<RedisService>(opt =>
            {
                RedisSettings redisSettings = opt.GetRequiredService<IOptions<RedisSettings>>().Value;
